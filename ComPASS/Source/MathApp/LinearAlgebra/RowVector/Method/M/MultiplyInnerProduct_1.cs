...
namespace Tremendous1192.SelfEmployed.CoMPASS.MathApp
{
        ...
        where T : struct
    {
        ...
        /// <returns></returns>
        public T MultiplyInnerProduct(RowVector<T> otherVector)
        {
        ...
        /// <returns></returns>
        public static T operator *(RowVector<T> vector01, RowVector<T> vector02)
        {
        ...
        /// <param name="vector02"></param>
        /// <returns></returns>
        public static T Multiply(RowVector<T> vector01, RowVector<T> vector02)
        {
