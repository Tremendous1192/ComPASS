...
namespace Tremendous1192.SelfEmployed.CoMPASS.MathApp
{
        ...
        where T : struct
    {
        ...
        /// <returns></returns>
        public static bool TestMeansDifference(double alpha, T[] group1, T[] group2, T std1, T std2, bool group1MeanIsHiger)
        {
            ...
            double z = (dynamic)((dynamic)summary1[6] - summary2[6]) / Math.Sqrt((dynamic)std1 / group1.Length + (dynamic)std2 / group2.Length);
