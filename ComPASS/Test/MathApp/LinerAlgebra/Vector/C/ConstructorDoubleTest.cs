...
namespace Test.Tremendous1192.SelfEmployed.CoMPASS.MathApp
{
    public partial class VectorTest
    {
        ...
        public void ConstructorDoubleTest()
        {
            ...
            ColumnVector<double> vector_1 = new ColumnVector<double>(dimension);
            ...
            var vector_2 = new ColumnVector<double>(copiedArray_1);
            Console.WriteLine("\n生成したベクトルの各要素を確認します。");
            ...
            var vector_3 = new ColumnVector<double>(copiedList_2);
            Console.WriteLine("\n生成したベクトルの各要素を確認します。");
